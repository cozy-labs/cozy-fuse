...
def main(argv=sys.argv):
    ...
    parser_configure.add_argument('device',
    ...
    parser_sync.add_argument('devices', nargs='*',
              help='Name of devices to sync').completer = DeviceCompleter
    ...
    parser_mount.add_argument('devices', nargs='*',
              help='Name of synchronized devices'\
                   ' to mount').completer = DeviceCompleter
    ...
    parser_unmount.add_argument('devices', nargs='*',
              help='Name of the synchronized device'\
                   ' to unmount').completer = DeviceCompleter
    ...
    parser_mount.add_argument('device',
              help='Name of the device to synchronize'\
                   '  and mount at startup').completer = DeviceCompleter
    ...
    parser_mount.add_argument('devices', nargs='*',
              help='Name of synchronized devices to remove'\
                   ' from startup').completer = DeviceCompleter
    ...
    parser_rmconf.add_argument('device',
              help='Name of the synchronized device').completer = DeviceCompleter
